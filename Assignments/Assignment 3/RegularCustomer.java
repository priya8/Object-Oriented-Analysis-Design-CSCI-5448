...
public class RegularCustomer extends Customer implements RandomizedInterface {
	...
	public RegularCustomer(String custId, int minAllowedTools, int maxAllowedTools, int minNights, int maxNights) {
